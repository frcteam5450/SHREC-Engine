...
public class Drivetrain extends Subsystem {
	...
	private static boolean mechanumToggle = false;
	/**
	...
	private static final CANTalon mtr_front_left = new CANTalon(RobotMap.mtr_front_left_port),
			...
			mtr_shooter = new CANTalon(RobotMap.mtr_shooter_port),     // Assigned the flyWheels to a talon and a port name
			mtr_climber = new CANTalon(RobotMap.mtr_climber_port);    // Assigned the ropeClimber to a talon and a port name
	...
	private static final Solenoid snd_mechanum_toggle = new Solenoid(RobotMap.snd_mechanum_toggle_port),
			snd_gear_toggle = new Solenoid(RobotMap.snd_gear_toggle_port);
	...
	public Drivetrain() {
		snr_gyro.calibrate();
		snr_gyro.reset();
		snd_mechanum_toggle.set(mechanumToggle);
	}
