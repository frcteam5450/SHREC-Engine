...
public class OI {
	...
	public Button jsk_btn_toggle_mechanum = new JoystickButton(jsk_left, RobotMap.jsk_btn_toggle_mechanum_port);
	public Button jsk_btn_toggle_gear = new JoystickButton(jsk_right, RobotMap.jsk_btn_toggle_gear_port);
	public Button jsk_btn_shooter_in = new JoystickButton(jsk_left, RobotMap.jsk_btn_shooter_in_port);
	public Button jsk_btn_shooter_out = new JoystickButton(jsk_left, RobotMap.jsk_btn_shooter_out_port);
	public Button jsk_btn_climber_up = new JoystickButton(jsk_left, RobotMap.jsk_btn_climber_up_port);
	public Button jsk_btn_climber_down = new JoystickButton(jsk_left, RobotMap.jsk_btn_climber_down_port);*/
	
	public Joystick jsk_xbox = new Joystick(RobotMap.jsk_xbox_port);

	public Button jsk_btn_toggle_mechanum = new JoystickButton(jsk_xbox, RobotMap.jsk_btn_toggle_mechanum_port);
	public Button jsk_btn_open_gear_tray = new JoystickButton(jsk_xbox, RobotMap.jsk_btn_open_gear_tray_port);
