...
public class RobotMap {
	 ...
	 */
	public static final int selected_robot = 0;                         //competition robot radio (curved top) = 1
	//public static final int jsk_right_port = 1;							//practice robot radio (flat top) = 0
	//public static final int jsk_left_port = 0;                   //Make sure to check mozilla roboRio input
	...
	public static final int jsk_btn_toggle_vision_gear_port = 9;
	public static final int jsk_btn_toggle_vision_boiler_port = 10;
	
	public static final double jsk_xbox_pov_delay = 0.2;
	
	/**
	 * These numbers correspond to the motor ports which make the robot move.
	 */
	public static final int mtr_climber_port = (new int[] {5, 11})[selected_robot];      //C:11 P:5
	public static final int mtr_shooter_port = (new int[] {4, 10})[selected_robot];      //C:10 P:4
	...
	public static final double thd_vision_aim_time = 4.0;
