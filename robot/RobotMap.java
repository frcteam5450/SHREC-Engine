...
public class RobotMap {
	 ...
	 */
	public static final int jsk_primary_right_port = 5;
	public static final int jsk_primary_left_port = 0;
	public static final int jsk_primary_btn_toggle_mechanum_port = 1;
	public static final int jsk_primary_btn_toggle_gear_port = 2;
	public static final int jsk_primary_btn_shooter_port = 3;
	public static final int jsk_primary_btn_climber_port = 4;
	...
	public static final int mtr_front_left_port = 3;
	public static final int mtr_front_right_port = 2;
	public static final int mtr_rear_left_port = 1;
	public static final int mtr_rear_right_port = 0;
	...
	public static final double spd_shooter = 1.0;
